...
-- 회원 샘플 데이터 삽입
INSERT INTO MEMBER VALUES (SEQ_MEMBER_NO.NEXTVAL, 'user01@kh.or.kr', 'pass01!', '유저일','01012345678', '04540,, 서울시 중구 남대문로 120,, 2층',
						DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO MEMBER VALUES (SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!', '유저이','01087654321', '04540,, 서울시 중구 남대문로 120,, 3층',
						DEFAULT, DEFAULT, DEFAULT, DEFAULT);

SELECT * FROM MEMBER; COMMIT;				
					
-- 로그인 SQL
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_TEL, MEMBER_ADDRESS, PROFILE_IMG, AUTHORITY, ENROLL_DATE 
FROM MEMBER
